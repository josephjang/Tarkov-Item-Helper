...
> **참고**: 이 저장소는 [Zeliper/Tarkov-Item-Helper](https://github.com/Zeliper/Tarkov-Item-Helper)에서 갈라져 나와 독립적으로 유지보수되는 포크입니다. 자체 릴리즈를 배포하며 — CalVer(`YYYY.M.N`) 버전 체계, **v2026.7.0**부터 시작 — 기능을 계속 추가하고 있습니다.
...
- **퀘스트** — 모든 퀘스트 조회·검색, 상태/트레이더/맵/Kappa/진영별 필터, 목표·선행·후속 퀘스트 확인, 다음에 할 퀘스트 추천
...
- **로그 파일** — 퀘스트·레이드 이벤트, 게임 모드, 플레이어 레벨은 게임 자체 로그에서 읽습니다
