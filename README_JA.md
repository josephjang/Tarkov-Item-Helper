...
> **注意**: このリポジトリは [Zeliper/Tarkov-Item-Helper](https://github.com/Zeliper/Tarkov-Item-Helper) から派生し、独立してメンテナンスされているフォークです。独自のリリースを配布しており — CalVer（`YYYY.M.N`）方式、**v2026.7.0** から開始 — 機能追加を継続しています。
