...
- **Completed**: 2025-12-19 (commit `bef1e27`, "feat(map): implement Map Markers overlay
  system" — same day the PRD was written), archived 2026-07 (bookkeeping only)
- **Summary**: Fully implemented as planned: `MarkerType` enum extended
  (`CultistSpawn`/`SniperScavSpawn`/`RogueSpawn`), and
